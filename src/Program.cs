...
record Album(int Id, string Title, string Artist, double Price, string Image_url)
{
     public static List<Album> GetAll(){
         var albums = new List<Album>(){
            ...
            new Album(3, "Scale It Up", "KEDA Club - Chnages", 13.99, "https://aka.ms/albums-kedalogo"),
            new Album(4, "Lost in Translation", "MegaDNS", 12.99,"https://aka.ms/albums-envoylogo"),
            new Album(5, "Lock Down Your Love - My Changes", "V is for VNET", 12.99, "https://aka.ms/albums-vnetlogo"),
